...
import 'package:flutter_advanced/infra/api/repositories/load_next_event_http_repository.dart';
...
class HttpClientSpy implements Client {
  ...
  void simulateFobiddenError() => statusCode = 403;
...
void main() {
  ...
  test('should request with correct method', () async {
    ...
    expect(httpClient.getCallsCount, 1);
  });
  ...
  test('should throw UnexpectedError on 403', () async {
    httpClient.simulateFobiddenError();
    final future = sut.loadNextEvent(groupId: groupId);
    expect(future, throwsA(DomainError.unexpected));
  });
