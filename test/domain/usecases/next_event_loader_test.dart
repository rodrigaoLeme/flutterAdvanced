...
import 'package:flutter_advanced/domain/usecases/next_event_loader.dart';
...
void main() {
  ...
  test('should return event data on success', () async {
    ...
    expect(event.players[0].initals, isNotEmpty);
    ...
    expect(event.players[1].initals, isNotEmpty);
